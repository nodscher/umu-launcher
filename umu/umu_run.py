...
def build_command(
    ...
    steamReaperCmd: tuple[Path | str, ... ] = ()
    if (steamBase := os.environ.get("STEAM_BASE_FOLDER")) and is_steammode:
        steamReaper: Path = Path(steamBase + "/ubuntu12_32/reaper")
        steamReaperCmd = (steamReaper, "SteamLaunch", "AppId=" + str(appId), "--")
